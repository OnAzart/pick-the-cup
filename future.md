...
3. Add a leaderboard (rank users by bracket accuracy once emails/predictions are persisted). Identity display decided: anonymous rank only, no name/email shown.
